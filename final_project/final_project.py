...
def filter_input_receiver(*wanted_input):
...
(Q) Quit program""")
    ...
    choice = filter_input_receiver("1", "2", "3", "4", "q")
...
is might take up a lot of time (use trial division up to √number) (Y/N):""")
                    ...
                    choice = filter_input_receiver("y", "n")
            ...
            choice = filter_input_receiver("r", "m")
...
ion): ",end="")
            ...
            print(f"This is your prime p, q, n (modulus) and e (public exponen\
t)\np = {prime_1}\nq = {prime_2}\nn = {modulus}\ne = {public_exponent}")
